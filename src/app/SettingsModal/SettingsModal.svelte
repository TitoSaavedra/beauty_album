<script lang="ts">
  ...
  import { saveConfig } from '../../shared/tauri/config';
  import type { AppConfig } from '../../shared/tauri/config';
  import { theme } from '../../stores/theme';
  import Button from '../../shared/components/Button/Button.svelte';
  import Input from '../../shared/components/Input/Input.svelte';
  import PillSelector from '../../shared/components/PillSelector/PillSelector.svelte';
