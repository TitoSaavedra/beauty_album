...
const LOGS_GET: &str = include_str!("../../commands/SQL/logs_get.sql");
const LOGS_STATS_TOTAL: &str = include_str!("../../commands/SQL/logs_stats_total.sql");
const LOGS_STATS_ERRORS: &str = include_str!("../../commands/SQL/logs_stats_errors.sql");
const LOGS_STATS_BY_SOURCE: &str = include_str!("../../commands/SQL/logs_stats_by_source.sql");
const LOGS_STATS_BY_TAG: &str = include_str!("../../commands/SQL/logs_stats_by_tag.sql");
